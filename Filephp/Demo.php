...
<body>
    <form action="#" method="POST" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr>
                <td><input type="number" name="f_acidity" step="0.01"></td>
                <td><input type="number" name="v_acidity" step="0.01"></td>
                <td><input type="number" name="c_acid" step="0.01"></td>
                <td><input type="number" name="r_sugar" step="0.01"></td>
                <td><input type="number" name="chlorides" step="0.01"></td>
                <td><input type="number" name="f_dioxide" step="0.01"></td>
                <td><input type="number" name="t_dioxide" step="0.01"></td>
                <td><input type="number" name="density" step="0.01"></td>
                <td><input type="number" name="pH" step="0.01"></td>
                <td><input type="number" name="sulphates" step="0.01"></td>
                <td><input type="number" name="alcohol" step="0.01"></td>
            </tr>
            <tr>
